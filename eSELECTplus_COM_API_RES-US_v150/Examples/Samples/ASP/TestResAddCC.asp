...
<%
	...
	Set resaddccrequest = server.CreateObject("Moneris.USResAddCC")
		resaddccrequest.setAvsInfo avs_street_number, avs_street_name, avs_zipcode

	out.setRequest resaddccrequest.formatRequest(cust_id, phone, email, note, pan, expdate, crypt_type)
	out.sendRequest
%>
