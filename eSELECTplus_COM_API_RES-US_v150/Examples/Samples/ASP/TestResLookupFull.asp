...
<%
	...
	order_id = "Lookup-"&Day(Date)&Month(Date)&Year(Date)&"-"&Hour(Now)&Minute(Now)&Second(Now)
	...
	Set request1 = server.CreateObject("Moneris.USResLookupFull")
...
<%
	...
	Response.Write "ResDataMaskedPan:  " & out.getResDataPan & "<br>"
