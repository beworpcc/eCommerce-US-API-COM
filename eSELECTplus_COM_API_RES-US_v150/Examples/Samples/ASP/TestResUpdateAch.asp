...
<%
	...
	order_id = "602" & Time()
	data_key = "LlPO7PJqBvxeuqjQFKhAbVkYl"
	...
	check_num = "100"
	cust_first_name = "Jerry"
	cust_last_name = "Smythe"
	cust_address1 = ""
	cust_address2 = ""
	cust_city = ""
	cust_state = ""
	...
	Set request1 = server.CreateObject("Moneris.USResUpdateAch")
		request1.setAchInfo sec, cust_first_name, cust_last_name, cust_address1, cust_address2, cust_city, cust_state, cust_zip, routing_num, account_num, check_num, account_type
