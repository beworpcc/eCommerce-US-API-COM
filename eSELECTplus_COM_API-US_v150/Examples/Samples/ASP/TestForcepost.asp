...
Set forcepostrequest = server.CreateObject("Moneris.USForcepost")
        forcepostrequest.setCustId custid
        forcepostrequest.setDynamicDescriptor "appstorep"


out.setRequest forcepostrequest.formatRequest(orderid, Amount, CardNum, Expdate, authcode, crypttype)
