...
Set cfrefundrequest = server.CreateObject("Moneris.USRefund")
        cfrefundrequest.setConvFee "1.00"

out.setRequest cfrefundrequest.formatRequest(orderid, Amount, txn_number, crypttype)
