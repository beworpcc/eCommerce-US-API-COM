...
Set indrefundrequest = server.CreateObject("Moneris.USIndependentRefund")
        indrefundrequest.setCustId custid
        indrefundrequest.setDynamicDescriptor "appstorei"
        indrefundrequest.setConvFee "1.00"

out.setRequest indrefundrequest.formatRequest(orderid, Amount, CardNum, Expdate, crypttype)
