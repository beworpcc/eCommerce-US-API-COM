...
<%
	...
	Set pinlessdebitrefund = server.CreateObject("Moneris.USPinlessDebitRefund")
		pinlessdebitrefund.setAmount amount

	out.setRequest pinlessdebitrefund.formatRequest(order_id, txn_number)
	out.sendRequest
%>
