...
store_id = "monusqa002"
api_token = "qatoken"
order_id = "encTrack2Purchase_" & DateDiff("s", CDate("1970/01/01 00:00:00"), Now)
custid = "Customer 001"
...
Set encTrack2PurchaseRequest = server.CreateObject("Moneris.USEncTrack2Purchase")
        encTrack2PurchaseRequest.setCustId custid

out.setRequest encTrack2PurchaseRequest.formatRequest(order_id, Amount, enc_track2, pos_code, device_type)
out.sendRequest
%>
