...
store_id = "monusqa002"
api_token = "qatoken"
order_id = "encTrack2IndependentRefund_" & DateDiff("s", CDate("1970/01/01 00:00:00"), Now)
custid = "Customer 001"
Amount = "10.00"
...
Set encTrack2IndependentRefundRequest = server.CreateObject("Moneris.USEncTrack2IndependentRefund")
        encTrack2IndependentRefundRequest.setCustId custid

out.setRequest encTrack2IndependentRefundRequest.formatRequest(order_id, Amount, enc_track2, pos_code, device_type)
out.sendRequest
%>
