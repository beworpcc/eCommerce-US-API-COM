...
Set track2preauthrequest = server.CreateObject("Moneris.USTrack2Preauth")
        track2preauthrequest.setCustId custid
        track2preauthrequest.setDynamicDescriptor "appstoretp"

out.setRequest track2preauthrequest.formatRequest(orderid, Amount, track2, CardNum, Expdate, pos_code)
