...
Set track2pcorrectionrequest = server.CreateObject("Moneris.USTrack2PurchaseCorrection")

out.setRequest track2pcorrectionrequest.formatRequest(orderid, txn_number)
