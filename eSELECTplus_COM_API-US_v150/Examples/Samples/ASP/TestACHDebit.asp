...
<%
	...
	order_id = "achDebit-"&Day(Date)&Month(Date)&Year(Date)&"-"&Hour(Now)&Minute(Now)&Second(Now)
	amount="5.00"
	...
	Set achdebitrequest = server.CreateObject("Moneris.USAchDebit")
		achdebitrequest.setAchInfo sec, cust_first_name, cust_last_name, cust_address1, cust_address2, cust_city, cust_state, cust_zip, routing_num, account_num, check_num, account_type

	out.setRequest achdebitrequest.formatRequest(order_id, amount)
