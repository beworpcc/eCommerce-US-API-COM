...
Set track2indrefundrequest = server.CreateObject("Moneris.USTrack2IndependentRefund")
        track2indrefundrequest.setCustId custid
        track2indrefundrequest.setDynamicDescriptor "appstoreti"

out.setRequest track2indrefundrequest.formatRequest(orderid, Amount, track2, CardNum, Expdate, pos_code)
