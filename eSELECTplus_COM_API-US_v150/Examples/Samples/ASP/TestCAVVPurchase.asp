...
<%
	...
	Set cavvpurchaserequest = server.CreateObject("Moneris.USCAVVPurchase")
		cavvpurchaserequest.setCustId cust_id
		cavvpurchaserequest.setDynamicDescriptor dynamic_descriptor

	out.setRequest cavvpurchaserequest.formatRequest(order_id, amount, pan, exp_date, cavv)
	out.sendRequest
%>
